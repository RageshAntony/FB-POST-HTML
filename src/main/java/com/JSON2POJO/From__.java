...
public class From__ implements Serializable
{
    ...
    @JsonProperty("id")
    private String id;
    private final static long serialVersionUID = 5854222522367898197L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof From__) == false) {
            return false;
        }
        From__ rhs = ((From__) other);
