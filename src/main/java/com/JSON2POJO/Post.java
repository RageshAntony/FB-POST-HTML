...
public class Post implements Serializable
{
    ...
    @JsonProperty("paging")
    private Paging_______ paging;
    private final static long serialVersionUID = -5799215672511771713L;
    ...
    @JsonProperty("paging")
    public Paging_______ getPaging() {
        return paging;
    }

    @JsonProperty("paging")
    public void setPaging(Paging_______ paging) {
        this.paging = paging;
    }
