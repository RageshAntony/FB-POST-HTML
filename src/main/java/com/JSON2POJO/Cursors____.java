...
public class Cursors____ implements Serializable
{
    ...
    private final static long serialVersionUID = -5449660770538209169L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cursors____) == false) {
            return false;
        }
        Cursors____ rhs = ((Cursors____) other);
