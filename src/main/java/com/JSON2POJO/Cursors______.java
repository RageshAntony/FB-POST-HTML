...
public class Cursors______ implements Serializable
{
    ...
    private final static long serialVersionUID = 2740155986214404926L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cursors______) == false) {
            return false;
        }
        Cursors______ rhs = ((Cursors______) other);
