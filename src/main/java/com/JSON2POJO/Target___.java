...
public class Target___ implements Serializable
{
    ...
    @JsonProperty("url")
    private String url;
    private final static long serialVersionUID = -8881562774899905107L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Target___) == false) {
            return false;
        }
        Target___ rhs = ((Target___) other);
