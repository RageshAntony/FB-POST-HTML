...
public class Cursors_____ implements Serializable
{
    ...
    private final static long serialVersionUID = -1205696845058660388L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cursors_____) == false) {
            return false;
        }
        Cursors_____ rhs = ((Cursors_____) other);
